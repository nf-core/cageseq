...
include { CUTADAPT_TRIMMING }   from '../../modules/local/cutadapt_trimming'       addParams( options: params.cutadapt_trimming_options )
include { CUTADAPT_5GTRIM }     from '../../modules/local/cutadapt_5gtrim'           addParams( options: params.cutadapt_5gtrim_options )
include { CUTADAPT_ARTEFACT }   from '../../modules/local/cutadapt_artefact'      addParams( options: params.cutadapt_artefact_options )
